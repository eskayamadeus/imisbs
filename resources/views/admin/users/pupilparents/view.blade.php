<!-- this page is to display PUPILPARENT details in admin panel. @ admin/users/staff/view -->
...
<div class="container-fluid">
  ...
  <hr>
    <h5 class="h5 mb-0 text-gray-800 text-uppercase">Parent Summary</h5>
    <br>
    ...
    <div class="col-xl-12 col-lg-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Parent Overview</h6>
        ...
        <!-- Card Body -->
        <div class="card-body">
                    @if(count($pupilparents) > 0)
                        <h5>Here you can view all parents.</h5>
                          <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                              ...
                              <tr>
                                  <td>{{$pupilparent->id}}</td>
                                  <td>{{$pupilparent->name}}</td>
                                  <td>{{$pupilparent->email}}</td>
                                  <td><a href="#" class="btn btn-primary"><i class="fas fa-pen"></i></a></td>
                                  {{-- <td><a href="#" class="btn btn-danger"><i class="fas fa-trash"></i></a></td> --}}
                                  <td>
                                    {!!Form::open(['action'=>['AdminController@destroyPupil', $pupilparent->id], 'method'=>'POST'])!!}
