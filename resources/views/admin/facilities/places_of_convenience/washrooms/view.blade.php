...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Washrooms</h1>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        ...
        <div class="card border-left-success shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-lg font-weight-bold text-success text-uppercase">View Washrooms</div>
              </div>
              <div class="col-auto">
  ...
  <hr>
    <h5 class="h5 mb-0 text-gray-800 text-uppercase">Pupil Summary</h5>
    <br>
  ...
  <div class="row">
    ...
    <div class="col-xl-12 col-lg-12">
      <div class="card shadow mb-4">
        ...
        <!-- Card Body -->
        <div class="card-body">
                    @if(count($washrooms) > 0)
                        <h5>Here you can view all washrooms.</h5>
                          <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                           ...
                           @else
                        <h5>You have no washrooms. <a href="">Create one</a></h5>
                    @endif
